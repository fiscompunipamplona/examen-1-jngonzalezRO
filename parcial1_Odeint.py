...
pendulo1=sphere(pos=vector(xp,yp,zp),radius=r,color=color.red,make_trail=True)#,trail_type="points")
...
cuerdas1=cylinder(pos=pendulo2.pos,axis=vector(0,0,0),radius=0.1,color=color.yellow)
cuerdas2=cylinder(pos=pendulo2.pos,axis=vector(l,0,0),radius=0.1,color=color.yellow)
base=box(pos=vector(l/2,0,0),size=vector(l+2,0.1,0.1),color=color.cyan)
spring=helix(pos=pendulo2.pos,axis=vector(0,0,0),radius=0.3,constant=k,thickness=0.1,coils=6,color=color.white)
ti=0
while ti<tf:
    sleep(0.01)
